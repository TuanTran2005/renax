        ...
        <div class="col-lg-8">
            ...
            <form action="{{route('paypost')}}?idpr={{$_GET['id']}}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="soluong" min="1" max="{{$buy->quantity}}" value="{{$_GET['sl']}}" id="quantity" placeholder="Nhập số lượng" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="color" name="color" value="{{ $_GET['color'] ? $_GET['color'] :  'White' }}" required readonly>
                </div>
...
<div class="login-message login-fail-message" id="login-fail-message" style="display:none;">
    ...
    <span>Số lượng không đủ, vui lòng chọn ít hơn {{$buy->quantity}}.</span>
</div>
